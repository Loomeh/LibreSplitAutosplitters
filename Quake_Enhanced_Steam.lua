...
function state()
    ...
    current.map = readAddress("string255", "0x18DDE30")
    current.intermission = readAddress("int", "0x9DD3AEC")
    current.menu = readAddress("int", "0xE7AC84")
end
